...
public class Main4 {
    public static void main(String[] args) {
        ...
        ChuyenXeNoiThanh CXNoT1 = new ChuyenXeNoiThanh(3, 100, "MS123", "Trương Hoàng Khoa", 59131078, 3000000);
        ChuyenXeNoiThanh CXNoT2 = new ChuyenXeNoiThanh(4, 130, "MS124", "Trần Minh Vương", 59134567, 2900000);
        ChuyenXeNoiThanh CXNoT3 = new ChuyenXeNoiThanh(5, 150, "MS125", "Trần Văn Biểu", 59135678, 2800000);
